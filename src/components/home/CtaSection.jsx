...
//       <div
//         aria-hidden
//         className="pointer-events-none absolute -bottom-48 left-1/2 -translate-x-1/2
//                    w-[600px] h-[600px]"
//         style={{
...
//         <div className="relative bg-card border border-strong rounded-[24px] px-12 py-16 overflow-hidden shadow-lg text-center">
...
//           <h2
//             className="font-display text-[clamp(2rem,4vw,3rem)] font-extrabold
//                        tracking-[-0.03em] text-ink mb-4"
//           >
//             Ready to Move at a Different Speed?
//           </h2>

//           <p className="text-[1rem] text-muted leading-[1.65] max-w-[480px] mx-auto mb-9">
//             Whether you're scaling infrastructure, launching AI, or rebuilding from
//             scratch — let's scope it in a single call. No commitment, no pitch deck.
//           </p>
